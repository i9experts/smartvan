    ...
    // 🔹 Final response format
    {
      $project: {
        van: {
          ...
          vehicleCategory: { $ifNull: ['$vehicleCategory', ''] },
          ...
          insuranceExpiry: { $ifNull: ['$insuranceExpiry', null] },
          registrationExpiry: { $ifNull: ['$registrationExpiry', null] },
          fitnessExpiry: { $ifNull: ['$fitnessExpiry', null] },
          routePermitExpiry: { $ifNull: ['$routePermitExpiry', null] },
          insuranceDocUrl: { $ifNull: ['$insuranceDocUrl', ''] },
          registrationDocUrl: { $ifNull: ['$registrationDocUrl', ''] },
          fitnessDocUrl: { $ifNull: ['$fitnessDocUrl', ''] },
          routePermitDocUrl: { $ifNull: ['$routePermitDocUrl', ''] },
        },
